...
<section style="background-color: #FFFFFF; padding: 20px;">
    ...
    <form action="/detailblog" method="post">
        @csrf
        <textarea placeholder="Komentar" name="komentar" style="width: 872px; height: 210px; border-radius: 8px; border: 1px solid #0000FF; margin-top: 20px; padding: 10px; margin-left: 300px;"></textarea>

        <button style="width: 100px; height: 40px; background-color: #FFC94A; border: none; border-radius: 8px; color: white; margin-top: 5px; display: block; margin-left: 300px;" type="submit">Kirim</button>
    </form>
