                        ...
                        <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                            <input type="text" name="nama" placeholder="Nama" style="width: 872px; height: 52px; border-radius: 8px; border: 1px solid #0000FF; margin-top: 20px; padding: 10px;">
                                            <input type="email" name="email" placeholder="Email" style="width: 872px; height: 52px; border-radius: 8px; border: 1px solid #0000FF; margin-top: 20px; padding: 10px;">
                                            <textarea placeholder="Komentar" name="komentar" style="width: 872px; height: 210px; border-radius: 8px; border: 1px solid #0000FF; margin-top: 20px; padding: 10px;"></textarea>
                                            <button style="width: 100px; height: 40px; background-color: #0000FF; border: none; border-radius: 8px; color: white; margin-top: 5px; display: block; margin-right: 100px; margin-left: 1100px;" type="submit">Kirim</button>
                                    </div>            
                                </div>
                            </div>
    </form>