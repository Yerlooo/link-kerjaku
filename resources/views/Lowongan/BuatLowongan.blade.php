...
<section style="background-color: #E8F2F7; padding: 70px; display: flex; align-items: center; justify-content: center;">
    <div style="margin-left: 55px;">
        ...
        <form action="/BuatLowongan" method="post">
            @csrf
            <input name="job_title" type="text" placeholder="Judul Pekerjaan" style="width: 100%; height: 40px; border: 1px solid black; border-radius: 8px; padding: 5px; margin-bottom: 20px;" required autofocus>
            <h6 style="text-align: left; margin-top: 15px;">Detail Pekerjaan*</h6>
            <input name="job_description" type="text" placeholder="Detail Pekerjaan" style="width: 100%; height: 40px; border: 1px solid black; border-radius: 8px; padding: 5px; margin-bottom: 20px;" required>
            <h6 style="text-align: left; margin-top: 15px;">Alamat Email*</h6>
            <input name="email" type="text" placeholder="Alamat Email" style="width: 100%; height: 40px; border: 1px solid black; border-radius: 8px; padding: 5px; margin-bottom: 20px;" required>
            <h6 style="text-align: left; margin-top: 15px;">Nama Perusahaan*</h6>
            <input name="company_name" type="text" placeholder="Nama Perusahaan" style="width: 100%; height: 40px; border: 1px solid black; border-radius: 8px; padding: 5px; margin-bottom: 20px;" required>
            <h6 style="text-align: left; margin-top: 15px;">Jenis Pekerjaan*</h6>
            <input name="job_type" type="text" placeholder="Jenis Pekerjaan" style="width: 100%; height: 40px; border: 1px solid black; border-radius: 8px; padding: 5px; margin-bottom: 20px;" required>
            <h6 style="text-align: left; margin-top: 15px;">Keterampilan yang diperlukan*</h6>
            <input name="required_skills" type="text" placeholder="Keterampilan yang diperlukan" style="width: 100%; height: 40px; border: 1px solid black; border-radius: 8px; padding: 5px; margin-bottom: 20px;" required>
...
<a href="/ProfillPerusahaan" style="text-decoration: none; margin-left: auto; margin-right: 855px; margin-top: -255px;">
    <button style="background-color: #FFC94A; border: none; border-radius: 8px; color: #000000; padding: 10px;">
