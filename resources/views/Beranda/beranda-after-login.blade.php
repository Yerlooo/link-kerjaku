    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            ...
            <div class="d-flex align-items-center">
                ...
                <button class="btn btn-secondary ms-3" role="button" onclick="event.preventDefault(); confirmLogout(event)">
                    Logout
                </button>
            </div>
        </div>
...
<section style="background-color: #FFFFFF; padding: 75px;">
    ...
    <div class="col-md-3 mb-4">
        <div class="card" style="width: 290px; height: 179px; border-radius: 20px; background-color: #1679AB; position: relative; margin-left: 20px;">
            <div class="card-body text-center">
...
<div class="col-md-3 mb-4">
    <div class="card" style="width: 290px; height: 179px; border-radius: 20px; background-color: #1679AB; position: relative; margin-left: 30px;">
        <div class="card-body text-center">
...
<div class="col-md-3 mb-4">
    <div class="card" style="width: 290px; height: 179px; border-radius: 20px; background-color: #1679AB; position: relative; margin-left: 40px;">
        <div class="card-body text-center">
        ...
        <div class="row justify-content-center">
        <div class="col-md-3 mb-4">
    <div class="card" style="width: 290px; height: 179px; border-radius: 20px; background-color: #1679AB; position: relative; margin-left: -3px;">
        <div class="card-body text-center">
...
<div class="col-md-3 mb-4">
    <div class="card" style="width: 290px; height: 179px; border-radius: 20px; background-color: #1679AB; position: relative; margin-left: 13px;">
        <div class="card-body text-center">
...
<div class="col-md-3 mb-4">
    <div class="card" style="width: 290px; height: 179px; border-radius: 20px; background-color: #1679AB; position: relative; margin-left: 46px;">
        <div class="card-body text-center">
