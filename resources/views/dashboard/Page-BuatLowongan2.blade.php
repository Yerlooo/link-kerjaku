...
.dropdown-content {
        ...
        .form-container h2, .form-container h5, .form-container h6 {
            color: #333;
            margin-bottom: 15px;
        }
        .form-container h2 {
        ...
        .form-container .section-buttons {
            display: flex;
            justify-content: space-between;
            align-items: center;
            margin-top: 40px;
        }
        .form-container .section-buttons a {
            text-decoration: none;
        }
    </style>
</head>
...
<section style="background-color: #FFFFFF; padding: 70px; display: flex; align-items: center; justify-content: center;">
    <div style="margin-left: 55px; margin-top: -45px;">
     ...
     <form action="/BuatLowongan2" method="post" class="form-container">
        ...
        <h5>Pengalaman*</h5>
        <input name="pengalaman" type="text" placeholder="Ketik Disini..." required>
